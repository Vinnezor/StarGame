...
public class Regions {
    ...
    /**
     * Р Р°Р·Р±РёРІР°РµС‚ TextureRegion РЅР° С„СЂРµР№РјС‹
     * @param region СЂРµРіРёРѕРЅ
     * @param rows РєРѕР»РёС‡РµСЃС‚РІРѕ СЃС‚СЂРѕРє
     * @param cols РєРѕР»РёС‡РµСЃС‚РІРѕ СЃС‚РѕР»Р±С†РѕРІ
     * @param frames РєРѕР»РёС‡РµСЃС‚РІРѕ С„СЂРµР№РјРѕРІ
     * @return РјР°СЃСЃРёРІ СЂРµРіРёРѕРЅРѕРІ
     */
